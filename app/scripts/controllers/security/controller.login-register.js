	...
	angular.module('app.security').
        ...
        if($scope.errors.length === 0) {
          ...
          api.registration.save('', data).$promise.then(function (response) {
            $scope.loading = false;
            notify({
              messageTemplate: '<i class="fa fa-check big-fa"></i><div class="notify-text">Gracias por registrarse en Werpi, recibirá un mail para completar el registro. <br/>Ingrese a su casilla de correos para finalizar el registro y completar la compra.</div>',
