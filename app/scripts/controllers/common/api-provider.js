 ...
 */
app.ApiEndpointConfig.prototype.addHttpAction = function(method, name, params, url) {
	this.actions[name] = {method: method.toUpperCase(), params: params, url:url};
...
app.ApiEndpoint.prototype.request = function(action, params, data) {
	return this.resource[action](params, data);
};
